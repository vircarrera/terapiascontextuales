<?php 
$courses = get_field('cursos_relacionados'); 
if ($courses) :     
?>
    <h2 class="c-subtitle e-subtitle-2">Formación relacionada</h2>

    <div class="e-related --course courserelatedcourse">
        <?php foreach ($courses as $post):
            setup_postdata($post); 
        ?>
            <div class="b-card --course courserelatedcourseitem" data-aos="fade-up">
                ...
                <div class="e-content">
                    <div class="e-wrapper">
                        <a href="<?php the_permalink(); ?>">
                            <h3 class="c-subtitle e-card-subtitle-4"><?php the_title(); ?></h3>
                        </a>
                ...
                </div> <!-- termina e-content -->
            </div> <!-- termina b-card --course -->
        <?php 
            wp_reset_postdata();
        endforeach;   ?>
    </div>
